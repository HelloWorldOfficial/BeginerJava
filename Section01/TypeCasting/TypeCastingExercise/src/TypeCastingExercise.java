...
public class TypeCastingExercise {
    public static void main(String[] args) {
        ...
        int small = 8; // LEAVE THIS

        /* Step 1: Practice changing a "small" data type into a "bigger" data type
         * Ths is what is known as Widening Primitive Conversion */
        System.out.println();

        /* Step 2: You may have noticed that this is not evaluating to what you would expect
         this is an example of a logical error lets try and fix this by declaring a variable <decimal> with a double type */
