...
public class LogicalOperatorsExercise {
    public static void main(String[] args) {
        ...
        // COMPARE WHETHER <num2> IS GREATER THAN <num1> AND <num2> IS LESS THAN <num3>
        ...
        // COMPARE WHETHER <num3> IS GREATER THAN <num1> OR IF <num2> IS GREATER THAN <num3>
        ...
        /* Step 3: Using the same variables as before determine the inverse of if <num2> is greater than <num1> print your result */
         ...
         // EVALUATE THE INVERSE OF THE STATEMENT <num2> IS GREATER THAN <num1>
